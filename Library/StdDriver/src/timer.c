 ...
 * @version  V3.00
 * $Revision: 6 $
 * $Date: 20/06/24 11:58a $
 * @brief    M0A21 Series Timer Controller (TIMER) Driver Source File
 *
 * @note
...
/**
  ...
  *
  * @param[in]  timer           The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  * @param[in]  u32DropCount    This parameter has no effect in M0A21 series BSP.
  * @param[in]  u32Timeout      This parameter has no effect in M0A21 series BSP.
...
/**
  ...
  *
  * @param[in]  timer       The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  * @param[in]  u32Mask     The mask of modules (PWM, DAC, ADC and PDMA) trigger by timer. Is the combination of
...
{
    timer->CTL = (timer->CTL & ~(TIMER_CTL_TRGPWM_Msk | TIMER_CTL_TRGDAC_Msk | TIMER_CTL_TRGADC_Msk | TIMER_CTL_TRGPDMA_Msk)) | (u32Mask);
}
