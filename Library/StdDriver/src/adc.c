 ...
 * $Revision: 3 $
 * $Date: 20/06/18 6:28p $
 * @brief    M0A21 Series ADC Driver Source File
 *
 * @note
...
/**
  ...
  * @return  None
  * @note M0A21 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
