 ...
 * $Revision: 3 $
 * $Date: 20/06/18 6:26p $
 * @brief    M0A21 Series ADC Driver Header File
 *
 * @note
...
#define ADC_ADCR_DIFFEN_DIFFERENTIAL    (1UL<<ADC_ADCR_DIFFEN_Pos)   /*!< Differential input type   \hideinitializer */
...
#define ADC_ADCR_SMPTSEL_4_CLOCK        (0UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 4 ADC peripheral clock cycle \hideinitializer */
#define ADC_ADCR_SMPTSEL_5_CLOCK        (1UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 5 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_6_CLOCK        (2UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 6 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_7_CLOCK        (3UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 7 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_8_CLOCK        (4UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 8 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_9_CLOCK        (5UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 9 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_10_CLOCK       (6UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 10 ADC peripheral clock cycles \hideinitializer */
#define ADC_ADCR_SMPTSEL_11_CLOCK       (7UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 11 ADC peripheral clock cycles \hideinitializer */
...
/**
  ...
  * @param[in] u32ChNum ADC Channel, valid value are from 0 to 16, 26, 27, 29 and 30.
  * @return  16-bit data.
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @param[in] u32ChNum  Specifies the source channel, valid value are from 0 to 16, 26, 27, 29 and 30.
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @param[in] u32Mask  Channel enable bit. Each bit corresponds to a input channel. Bit 0 is channel 0, bit 1 is channel 1..., bit 30 is channel 30.
  * @return None
