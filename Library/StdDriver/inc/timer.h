 ...
 * $Revision: 4 $
 * $Date: 20/06/18 6:26p $
 * @brief    M0A21 Series Timer Driver Header File
 *
 * @note
...
#define TIMER_CAPTURE_EVENT_FALLING             (0UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Falling edge detection to trigger capture event \hideinitializer \hideinitializer */
#define TIMER_CAPTURE_EVENT_RISING              (1UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Rising edge detection to trigger capture event \hideinitializer \hideinitializer */
...
#define TIMER_CAPTURE_PULSE_FALLING_FALLING     (0UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Measue single pulse from falling edge to falling edge \hideinitializer */
#define TIMER_CAPTURE_PULSE_RISING_RISING       (1UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Measue single pulse from rising edge to rising edge \hideinitializer */
#define TIMER_CAPTURE_PULSE_FALLING_RISING      (6UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Measue single pulse from falling edge to rising edge \hideinitializer */
#define TIMER_CAPTURE_PULSE_RISING_FALLING      (7UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Measue single pulse from rising edge to falling edge \hideinitializer */
